<?php
// Admin Side Navigation Bar Component
// This component contains all the navigation items for admin dashboard
?>
<aside class="admin-sidebar" id="adminSidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav-list">
            ...
            <li class="nav-item">
                <a href="#" onclick="showSection('batches')" class="nav-link" data-section="batches">
            ...
            <li class="nav-item">
                <a href="#" onclick="showSection('students')" class="nav-link" data-section="students">
            ...
            <li class="nav-item">
                <a href="#" onclick="showSection('lecturers')" class="nav-link" data-section="lecturers">
    ...
    <div class="sidebar-footer">
        <div class="user-profile">
            ...
            <div class="user-details">
                <div class="user-name"><?= htmlspecialchars($_SESSION['email'] ?? 'Admin') ?></div>
...
<!-- CSS is now in external file: admin_sidebar.css -->
